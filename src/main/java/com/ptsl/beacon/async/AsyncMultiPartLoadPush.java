...
public class AsyncMultiPartLoadPush {
    ...
    public static void main(String[] args) {
        ...
        if(SmppBindType.RECEIVER.equals(config.bindType) )
        {
            startReceiver(config);
        }else {
            startTransmitter(config);
        }
    ...
    private static void startReceiver(LoadTestConfig config)
    {
        printConfig(config);
    ...
    private static void startTransmitter(LoadTestConfig config)
    {
        printConfig(config);
